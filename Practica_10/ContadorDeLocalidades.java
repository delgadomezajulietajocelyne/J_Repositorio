...
public class ContadorDeLocalidades {
    ...
    public boolean EmpiezaConDirectivaOConOrg(Linea linea_ens,FileWriter archErr,int numeroLinea,FileWriter archInst, ArbolEtiquetas arboletq,FileWriter archTABSIM, String nombrearch){
    		...
    		if(linea_ens.codop.equalsIgnoreCase("ORG")) {
    			...
    			if (conver >=0 && conver<=65535){
    				...
    				if (linea_ens.etq.equalsIgnoreCase("NULL")){
    					...
    					escribirenINST(numeroLinea,conloc,linea_ens,nombrearch);
    			...
    			//contloc = contloc
    				...
    				if(linea_ens.codop.equalsIgnoreCase("EQU")) {
    					...
    					if (conver >=0 && conver<=65535){
							...
							if (linea_ens.etq.equalsIgnoreCase("NULL")){
    								escribirenINST(numeroLinea,conlocdeequ,linea_ens,nombrearch);
