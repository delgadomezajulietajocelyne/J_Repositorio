...
public class Operador {
    ...
    public void VerificarInicioDeOperador(String oper, ArrayList<String> modosdir, FileWriter archErr, int numeroLinea, Linea linea_ens,FileWriter archInst,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, String nombrearch) {
    	int convdecimal;
    	...
    	try {
    				...
    				if(oper.length()<=8){
    					...
    					try{
    						...
    						if (linea_ens.etq.equalsIgnoreCase("NULL")) {
    							escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "INH",nombrearch);
    				...
    				for(int i = 0;i<modosdir.size();i++){
                			if (modosdir.get(i).equals("INH")) {
                				...
                				if (modosdir.get(i).equals("IMM")) {
    								...
    								if (linea_ens.etq.equalsIgnoreCase("NULL")) {
    									escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "IMM",nombrearch);
                					...
                					if (modosdir.get(i).equals("IDX")) {
    									...
    									if (linea_ens.etq.equalsIgnoreCase("NULL")) {
    										escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "IDX",nombrearch);
    			...
    			if (oper.matches ("^[a-zA-Z].*") && oper.matches("[a-zA-Z0-9_]+")){
    				if(oper.length()<=8){
    					...
    					try{
    						...
    						if (linea_ens.etq.equalsIgnoreCase("NULL")) {
    							escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "REL8",nombrearch);
    				...
    				if (convdecimal != 65536){
    					VerifRel8(relativo,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    				}
    			}
    			...
    			if (relativo.equals("REL9")){
    				...
    				if (oper.matches ("^[a-zA-Z].*") && oper.matches("[a-zA-Z0-9_]+")){
    					if(oper.length()<=8){
    						...
    						try{
    							...
    							if (linea_ens.etq.equalsIgnoreCase("NULL")) {
    								escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "REL9",nombrearch);
    					...
    					if (convdecimal != 65536){
    						VerifRel9(relativo,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    					}
    				}
    			}
    			else {
    					...
    					if (oper.matches ("^[a-zA-Z].*") && oper.matches("[a-zA-Z0-9_]+")){
    						if(oper.length()<=8){
    							...
    							try{
    								...
    								if (linea_ens.etq.equalsIgnoreCase("NULL")) {
    										escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "REL16",nombrearch);
    						...
    						if (convdecimal != 65536){
    							VerifRel16(relativo,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    						}
    						else {
    							linea_ens.errorLinea = true;
    				...
    				if(oper.matches("^#.*")){
    					...
    					if(Inmediato.equals("IMM8") || Inmediato.equals("IMM16")) {
    						...
    						if (convdecimal != 65536)
    							VerifInmediato(Inmediato,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    					}
    					else {
    						linea_ens.errorLinea = true;
    					...
    					if (comas == 0 && !oper.startsWith("[")){
    						...
    						if (ambos == false && dir == true){
    							if(loquetiene.matches("^@{1,}.*") || loquetiene.matches("^%{1,}.*") || (hx==true)  || loquetiene.matches("[0-9_]+"))
    							{
									...
									if (convdecimal != 65536)
										VerifDirecto(directo,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    							}
    							else {
    								linea_ens.errorLinea = true;
    							...
    							if (ambos == false && ext == true){
    								...
    								if (linea_ens.etq.equalsIgnoreCase("NULL")) {
    									escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "EXT",nombrearch);
    									...
    									if(loquetiene.matches("^@{1,}.*") || loquetiene.matches("^%{1,}.*") || (hx==true) || loquetiene.matches("[0-9_]+")){
    										...
    										if (convdecimal != 65536)
												VerifExtendido(extendido,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    								...
    								if (ambos == true){
    									if (oper.matches ("^[a-zA-Z].*") && oper.matches("[a-zA-Z0-9_]+")){
    										...
    										if(loquetiene.matches("^@{1,}.*") || loquetiene.matches("^%{1,}.*") || (hx==true) || loquetiene.matches("[0-9_]+")){
    											...
    											if (convdecimal != 65536)
													VerifDIRYEXT(extendido,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
												else {
													linea_ens.errorLinea = true;
													linea_ens.guardarError(archErr,"ERROR Formato de operador incorrecto para "+"EXT",numeroLinea);
												}
    						...
    						if (comas >= 1 && !oper.startsWith("[") && !oper.endsWith("]")){
    							...
    							if (comas == 1){
    								...
    								if (canttokens == 0) {
    									System.out.println("CANTIDAD DE TOKENS: "+canttokens);
    									System.out.println("ERROR Formato de operando inválido para ningun modo de direccionamiento: "+numeroLinea);
    									linea_ens.errorLinea = true;
    									//System.out.println("ERROR Formato de operando inválido para ningun modo de direccionamiento: "+numeroLinea);
    									//linea_ens.guardarError(archErr,"ERROR Formato de operando inválido para ningun modo de direccionamiento",numeroLinea);
										//System.out.println("ERROR Formato de operando inválido para ningun modo de direccionamiento: "+numeroLinea);
    									...
    									System.out.println("aca con mas TOKENS: "+canttokens);
    								...
    								if (porsiempiezaconacum.equalsIgnoreCase("a") || porsiempiezaconacum.equalsIgnoreCase("b") || porsiempiezaconacum.equalsIgnoreCase("d")){
    									...
    									VerifIDXAcum(Indexado,0,archErr,numeroLinea,linea_ens,archInst,registro,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    								}
    									...
    									if (canttokens != 1){
    										...
    										System.out.println("CONVDECIMAL: "+convdecimal);
    									}
    									...
    									if (convdecimal != 65536 && ((convdecimal>= -16 && convdecimal <=15) || ((registro.equalsIgnoreCase("-x") || registro.equalsIgnoreCase("+x") || registro.equalsIgnoreCase("x-") || registro.equalsIgnoreCase("x+") || registro.equalsIgnoreCase("-y") || registro.equalsIgnoreCase("+y") || registro.equalsIgnoreCase("y-") || registro.equalsIgnoreCase("y+") || registro.equalsIgnoreCase("-sp") || registro.equalsIgnoreCase("+sp") || registro.equalsIgnoreCase("sp-") || registro.equalsIgnoreCase("sp+")))) && Indexado.equals("IDX")){
    										//Indexado = "IDX";
    										VerifIDX(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    									}
    									else{
    										for(int i = 0;i<modosdir.size();i++){
                								//archInst.write((String)reco.modosdir.get(i));
    										...
    										if (convdecimal != 65536 && (convdecimal>= -256 && convdecimal <=255) && Indexado.equals("IDX1") && !oper.startsWith("[") && !oper.endsWith("[")){
    											//Indexado = "IDX1";
    											VerifIDX1(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    										}
    										else {
    											for(int i = 0;i<modosdir.size();i++){
                									//archInst.write((String)reco.modosdir.get(i));
    											...
    											if (convdecimal != 65536 && (convdecimal>= 0 && convdecimal <=65535) && Indexado.equals("IDX2")){
    												//Indexado = "IDX2";
    												VerifIDX2(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    											}
    											/*else {
    							...
    							if (comas==1 && oper.startsWith("[") && oper.endsWith("]")){
    								...
    								if(tieneaD.equalsIgnoreCase("D")){
    									...
    									IndizadoDeAcumuladorD(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    								}
    								else {
    									...
    									String registro = opConvertir.nextToken();
    									System.out.println(registro);
    									Indirecto16bits(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumab,contlocalidades,arboletq,archTABSIM,modosdir,nombrearch);
    								}
    		...
    		archInst.close();
            	...
            	System.err.println("Ocurrio un error ooooper: " + e.getMessage());
              }
    		...
    		if(contenido.matches("^@.*")){
    			...
    			if(contenido.matches("^%.*")){
    				...
    				if(contenido.matches("[0-1_]+")){
    					if(contenido.startsWith("1") && contenido.length()>1) {
    						System.out.println("Binario: "+contenido);
    ...
    public int ConversionAComplementoADos (String binario) {
 	...
 	public void VerifInmediato(String tipoinmediato,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq, FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			...
 			if (tipoinmediato.equals("IMM8")) {
      				if (resultadoc_2 >= -256 && resultadoc_2 <=255){
    					...
    					if (linea_ens.etq.equalsIgnoreCase("NULL")){
    					escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, tipoinmediato,nombrearch);
            	...
            	System.err.println("Ocurrio un error INMEDIATO: " + e.getMessage());
              }
 	}


 	public void VerifDirecto(String directo,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (directo.equals("DIR")) {
      				if (resultadoc_2 >= 0 && resultadoc_2 <=255){
      					...
      					if (linea_ens.etq.equalsIgnoreCase("NULL")){
    							escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, directo,nombrearch);
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error DIRECTO: " + e.getMessage());
              }
 	}

 	public void VerifExtendido(String extendido,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (extendido.equals("EXT")) {
      				if (resultadoc_2 >= -32768 && resultadoc_2 <=65535){
							...
							if(modosdir.get(posi).equalsIgnoreCase("EXT")){
      						...
      						if (linea_ens.etq.equalsIgnoreCase("NULL")){
      							escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, extendido,nombrearch);
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error EXTENDIDO: " + e.getMessage());
              }
 	}

 	public void VerifDIRYEXT(String extendido,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
      				if (resultadoc_2 >= 0 && resultadoc_2 <=255){
      					...
      					if (linea_ens.etq.equalsIgnoreCase("NULL")){
    							escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "DIR",nombrearch);
    						...
    						System.out.println ("existe");
    						if (existeEtq == false) {
    							System.out.println ("voy a esc");
    							escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, "DIR",nombrearch);
    							System.out.println ("voy a esc");
    								//archInst.write(numeroLinea+"\t\t"+contlocalidades.conloc+"\t\t"+linea_ens.etq+"\t\t"+linea_ens.codop+"\t\t"+linea_ens.oper+"\t\t"+"DIR"+"\r\n");
									System.out.println ("voy a tab");
        							EscribirEnTABSIM(archTABSIM,linea_ens,contlocalidades);
            	...
            	System.err.println("Ocurrio un error DIRYEXT: " + e.getMessage());
              }
 	}

 	public void VerifIDX(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir, String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("IDX")) {
      				...
      				if (registro.equalsIgnoreCase("x") || registro.equalsIgnoreCase("y") || registro.equalsIgnoreCase("sp") || registro.equalsIgnoreCase("pc")){
      					//IDX NORMAL
      						if ((resultadoc_2 >= -16 && resultadoc_2 <=15)){
      							System.out.println ("Es IDX");
      							System.out.println("CONLOCcc: "+contlocalidades.conloc);
      							for(int posi = 0;posi<modosdir.size();posi++){
									if(modosdir.get(posi).equalsIgnoreCase("IDX")){
										sumadebytes = sumab.get(posi);
              						}
      							...
      							if (linea_ens.etq.equalsIgnoreCase("NULL")){
    								...
    								boolean existeEtq = arboletq.insertar (linea_ens.etq,contlocalidades.conloc);
    								if (existeEtq == false) {
    									System.out.println("VOY A ESCRIBIR EN INST");
    									escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens,idx, nombrearch);
    										//archInst.write(numeroLinea+"\t\t"+contlocalidades.conloc+"\t\t"+linea_ens.etq+"\t\t"+linea_ens.codop+"\t\t"+linea_ens.oper+"\t\t"+idx+"\r\n");
										System.out.println("ESCRIBI EN INST");
											System.out.println("VOY A ESCRIBIR EN tabsim");
        									EscribirEnTABSIM(archTABSIM,linea_ens,contlocalidades);
        									System.out.println("ESCRIBI EN TABSIM");
        									//calcular conloc sig.
    										int sumbytes = Integer.parseInt(sumadebytes,10);
    										int i = Integer.parseInt(contlocalidades.conloc,16) + sumbytes;
    										contlocalidades.conloc = Integer.toHexString(i);
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error IDX: " + e.getMessage());
              }
 	}

 	public void VerifIDXAcum(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			//System.out.println("ENTERO: ");
 			if (idx.equals("IDX")) {
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error IDX ACUM: " + e.getMessage());
        }
 	}

 	public void VerifIDX1(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("IDX1")) {
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error IDX1: " + e.getMessage());
              }
 	}

 	public void VerifIDX2(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("IDX2")) {
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error IDX2: " + e.getMessage());
              }
 	}

 	public void Indirecto16bits(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("[IDX2]")) {
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error INDIR 16 bit: " + e.getMessage());
              }
 	}

 	//IndizadoDeAcumuladorD
 	public void IndizadoDeAcumuladorD(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			if (idx.equals("[D,IDX]")) {
 				if (registro.equalsIgnoreCase("x") || registro.equalsIgnoreCase("y") || registro.equalsIgnoreCase("sp") || registro.equalsIgnoreCase("pc")){
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error INDIZADO ACUMD: " + e.getMessage());
              }
 	}

 	public void VerifRel8(String relativo,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (relativo.equals("REL8")) {
      				if (resultadoc_2 >= -128 && resultadoc_2 <=127){
      						...
      						if (linea_ens.etq.equalsIgnoreCase("NULL")){
    							escribirenINST(numeroLinea,contlocalidades.conloc,linea_ens, relativo,nombrearch);
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error REL 8: " + e.getMessage());
              }
 	}

 	public void VerifRel9(String relativo,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (relativo.equals("REL9")) {
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error REL9: " + e.getMessage());
              }
 	}

 	public void VerifRel16(String relativo,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,ArrayList<String> sumab,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM, ArrayList<String> modosdir,String nombrearch){
 		String sumadebytes="";
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (relativo.equals("REL16")) {
      		...
      		archInst.close();
            	...
            	System.err.println("Ocurrio un error en clase OPERADOR REL16: " + e.getMessage());
              }
 	}
 	...
 	public void EscribirEnTABSIM (FileWriter archTABSIM,Linea linea_ens, ContadorDeLocalidades contlocalidades) {
 		...
 		try{
    		archTABSIM.write(linea_ens.etq+"\t\t"+contlocalidades.conloc+"\r\n");
            	...
            	System.err.println("Ocurrio un error en clase OPERADOR EscribirEnTABSIM: " + e.getMessage());
              }

 	}
 	
 	public void escribirenINST(int numeroLinea,String conloc,Linea linea_ens, String modo, String nombrearch){
    /*	try{
            ...
            try {
    					...
    					while (archInst.getFilePointer()!=archInst.length()){
    	 				...
    	 				//archInst.writeBytes("\r\n");
    					archInst.writeBytes(numeroLinea+"\t\t"+conloc+"\t\t"+linea_ens.etq+"\t\t"+linea_ens.codop+"\t\t"+linea_ens.oper+"\t\t"+modo+"\r\n");
    					archInst.close();
              		}
              		catch (Exception e){ //Catch de excepciones
            			System.err.println("Ocurrio un error: " + e.getMessage());
