...
public class Operador {
    ...
    public void VerificarInicioDeOperador(String oper, ArrayList<String> modosdir, FileWriter archErr, int numeroLinea, Linea linea_ens,FileWriter archInst,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM) {
    	int convdecimal;
    	...
    	try {
    		...
    		if (relativo.equals("REL8")){
    			...
    			if (oper.matches ("^[a-zA-Z].*") && oper.matches("[a-zA-Z0-9_]+")){
    				...
    				if (convdecimal != 65536){
    					VerifRel8(relativo,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumadebytes,contlocalidades,arboletq,archTABSIM);
    				}
    			}
    			...
    			if (relativo.equals("REL9")){
    				if (oper.matches ("^[a-zA-Z].*") && oper.matches("[a-zA-Z0-9_]+")){
    					...
    					if (convdecimal != 65536){
    						VerifRel9(relativo,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumadebytes,contlocalidades,arboletq,archTABSIM);
    					}
    				}
    			}
    			else {
    				...
    				if (relativo.equals("REL16")){
    					...
    					if (oper.matches ("^[a-zA-Z].*") && oper.matches("[a-zA-Z0-9_]+")){
    						...
    						if (convdecimal != 65536){
    							VerifRel16(relativo,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumadebytes,contlocalidades,arboletq,archTABSIM);
    						}
    						else {
    				...
    				if(oper.matches("^#.*")){
    					...
    					if(Inmediato.equals("IMM8") || Inmediato.equals("IMM16")) {
    						...
    						if (convdecimal != 65536)
    							VerifInmediato(Inmediato,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumadebytes,contlocalidades,arboletq,archTABSIM);
    					}
    					else {
    					...
    					if (comas == 0 && !oper.startsWith("[")){
    						...
    						if (ambos == false && dir == true){
    							if(loquetiene.matches("^@{1,}.*") || loquetiene.matches("^%{1,}.*") || (hx==true)  || loquetiene.matches("[0-9_]+"))
    							{
									...
									if (convdecimal != 65536)
										VerifDirecto(directo,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumadebytes,contlocalidades,arboletq,archTABSIM);
    							}
    							else {
    							...
    							if (ambos == false && ext == true){
    								...
    								if (linea_ens.etq.equalsIgnoreCase("NULL")) {
    									...
    									if(loquetiene.matches("^@{1,}.*") || loquetiene.matches("^%{1,}.*") || (hx==true) || loquetiene.matches("[0-9_]+")){
    										...
    										if (convdecimal != 65536)
												VerifExtendido(extendido,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumadebytes,contlocalidades,arboletq,archTABSIM);
    								...
    								if (ambos == true){
    									if (oper.matches ("^[a-zA-Z].*") && oper.matches("[a-zA-Z0-9_]+")){
    										...
    										if(loquetiene.matches("^@{1,}.*") || loquetiene.matches("^%{1,}.*") || (hx==true) || loquetiene.matches("[0-9_]+")){
    											...
    											if (convdecimal != 65536)
													VerifDIRYEXT(extendido,convdecimal,archErr,numeroLinea,linea_ens,archInst,sumadebytes,contlocalidades,arboletq,archTABSIM);
												else
													linea_ens.guardarError(archErr,"ERROR Formato de operador incorrecto para "+"EXT",numeroLinea);
    										}
    										else {
    						...
    						if (comas >= 1 && !oper.startsWith("[") && !oper.endsWith("]")){
    							...
    							if (comas == 1){
    								...
    								if (porsiempiezaconacum.equalsIgnoreCase("a") || porsiempiezaconacum.equalsIgnoreCase("b") || porsiempiezaconacum.equalsIgnoreCase("d")){
    									...
    									VerifIDXAcum(Indexado,0,archErr,numeroLinea,linea_ens,archInst,registro,sumadebytes,contlocalidades,arboletq,archTABSIM);
    								}
    									...
    									if (convdecimal != 65536 && ((convdecimal>= -16 && convdecimal <=15) || ((registro.equalsIgnoreCase("-x") || registro.equalsIgnoreCase("+x") || registro.equalsIgnoreCase("x-") || registro.equalsIgnoreCase("x+") || registro.equalsIgnoreCase("-y") || registro.equalsIgnoreCase("+y") || registro.equalsIgnoreCase("y-") || registro.equalsIgnoreCase("y+") || registro.equalsIgnoreCase("-sp") || registro.equalsIgnoreCase("+sp") || registro.equalsIgnoreCase("sp-") || registro.equalsIgnoreCase("sp+")))) && Indexado.equals("IDX")){
    										//Indexado = "IDX";
    										VerifIDX(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumadebytes,contlocalidades,arboletq,archTABSIM);
    									}
    									else{
    										for(int i = 0;i<modosdir.size();i++){
                								//archInst.write((String)reco.modosdir.get(i));
    										...
    										if (convdecimal != 65536 && (convdecimal>= -256 && convdecimal <=255) && Indexado.equals("IDX1") && !oper.startsWith("[") && !oper.endsWith("[")){
    											//Indexado = "IDX1";
    											VerifIDX1(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumadebytes,contlocalidades,arboletq,archTABSIM);
    										}
    										else {
    											for(int i = 0;i<modosdir.size();i++){
                									//archInst.write((String)reco.modosdir.get(i));
    											...
    											if (convdecimal != 65536 && (convdecimal>= 0 && convdecimal <=65535) && Indexado.equals("IDX2")){
    												//Indexado = "IDX2";
    												VerifIDX2(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumadebytes,contlocalidades,arboletq,archTABSIM);
    											}
    											/*else {
    							...
    							if (comas==1 && oper.startsWith("[") && oper.endsWith("]")){
    								...
    								if(tieneaD.equalsIgnoreCase("D")){
    									...
    									IndizadoDeAcumuladorD(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumadebytes,contlocalidades,arboletq,archTABSIM);
    								}
    								else {
    									...
    									String registro = opConvertir.nextToken();
    									System.out.println(registro);
    									Indirecto16bits(Indexado,convdecimal,archErr,numeroLinea,linea_ens,archInst,registro,sumadebytes,contlocalidades,arboletq,archTABSIM);
    								}
    ...
    public int ConversionAComplementoADos (String binario) {
 	...
 	public void VerifInmediato(String tipoinmediato,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq, FileWriter archTABSIM){
 		try{
 	...
 	public void VerifDirecto(String directo,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 	...
 	public void VerifExtendido(String extendido,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 	...
 	public void VerifDIRYEXT(String extendido,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
      				if (resultadoc_2 >= 0 && resultadoc_2 <=255){
 	...
 	public void VerifIDX(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("IDX")) {
 	...
 	public void VerifIDXAcum(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("IDX")) {
 	...
 	public void VerifIDX1(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("IDX1")) {
 	...
 	public void VerifIDX2(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("IDX2")) {
 	...
 	public void Indirecto16bits(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (idx.equals("[IDX2]")) {
 	...
 	public void IndizadoDeAcumuladorD(String idx,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst, String registro,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			if (idx.equals("[D,IDX]")) {
 				if (registro.equalsIgnoreCase("x") || registro.equalsIgnoreCase("y") || registro.equalsIgnoreCase("sp") || registro.equalsIgnoreCase("pc")){
      					System.out.println ("Es IDX");
 	...
 	public void VerifRel8(String relativo,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (relativo.equals("REL8")) {
 	...
 	public void VerifRel9(String relativo,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (relativo.equals("REL9")) {
 	...
 	public void VerifRel16(String relativo,int resultadoc_2,FileWriter archErr,int numeroLinea, Linea linea_ens,FileWriter archInst,String sumadebytes,ContadorDeLocalidades contlocalidades,ArbolEtiquetas arboletq,FileWriter archTABSIM){
 		try{
 			System.out.println("ENTERO: "+resultadoc_2);
 			System.out.println("ENTERO: ");
 			if (relativo.equals("REL16")) {
